...
parser.add_argument('--dataroot', required=True, help='path to dataset', default="~/datasets/data_cifar10")
parser.add_argument('--use_cuda', type=boolean_string, default=True)
parser.add_argument('--save_model_dir', required=True, default="./try")
parser.add_argument('--save_image_dir', required=True, default="./try")
