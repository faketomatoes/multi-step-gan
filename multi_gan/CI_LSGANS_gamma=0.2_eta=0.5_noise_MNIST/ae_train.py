...
parser.add_argument('--dataset', help='cifar10 | mnist', default="mnist")
parser.add_argument('--dataroot', help='path to dataset', default="~/datasets")
parser.add_argument('--cuda_device', default="2")
...
torch.save(encoder.state_dict(), os.path.join(opt.save_model_dir, 'sim_encoderL1.pth'))
